...
def generarMenu(usuario):
    ...
    with st.sidebar:
        ...
        st.page_link("Ventas.py", label="Inicio", icon=":material/home:")
        st.subheader("Tableros")
        st.page_link("pages/Empaque.py", label="Empaque", icon=":material/sell:")
        st.page_link("pages/LtKg.py", label="LtKg", icon=":material/shopping_cart:")
        st.page_link("pages/Marcas.py", label="Marcas", icon=":material/group:")    
